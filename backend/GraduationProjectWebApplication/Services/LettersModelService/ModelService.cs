...
namespace GraduationProjectWebApplication.Services.LettersModelService
{
    public class ModelService : IModelService
    {
        ...
        private readonly string[] _arabicLabels = GraduationProject.StaticDetails.Labels._arabicLabels; // Arabic labels (for display and internal use)
        private readonly string[] _englishLabels = GraduationProject.StaticDetails.Labels._englishLabels; // English labels (for debuging)
